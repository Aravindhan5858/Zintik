...
const SignInPage = () => {
  ...
  const handleSignIn = async (e) => {
    e.preventDefault();
    // Redirect to the dedicated login page where password is requested
    // or attempt an email-only magic link in future. For now navigate to /login
    navigate('/login')
  };
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white p-8 lg:p-16">
        ...
        >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 py-2 rounded-lg"
          >
            <img
